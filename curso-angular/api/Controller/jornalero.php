...
class Jornalero extends Controller
{
    ...
    public function findJornalero($idJornalero){
        try 
        {
            $this->modelJornalero->__SET('idJornalero', $idJornalero);
            $this->response->result = $this->modelJornalero->findJornalero();
            return json_encode($this->response->SetResponse(true));
        } 
        catch (Exception $e) 
        {
    ...
    public function updateSimple($idJornalero, $nombres, $correo){
        ...
        try 
        {
            if($this->modelJornalero->updateSimple())
            {
                return json_encode($this->response->SetResponse(true));
            }
            else
