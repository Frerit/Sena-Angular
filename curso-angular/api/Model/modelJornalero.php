...
class ModelJornalero
{
    ...
    public function findJornalero()
    {
        $sql = "SELECT idJornalero, nombres, correo, fechaNacimiento, peso, imagen FROM tbljornalero WHERE idJornalero = :idJornalero";
        $query = $this->db->prepare($sql);
    ...
    {
        $sql = "SELECT idJornalero, nombres, correo, fechaNacimiento, peso, imagen FROM tbljornalero";
        $query = $this->db->prepare($sql);
        $query->execute();
        return $query->fetchAll();
    }
    ...
    {
        $sql = "UPDATE tbljornalero SET nombres = :nombres, correo = :correo WHERE idJornalero = :idJornalero";
        $query = $this->db->prepare($sql);
